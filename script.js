...
function encriptar(texto) {
    ...
    .toLowerCase()
    .split('')
    .map(letra => reglasEncriptado[letra] || letra) // Reemplazamos cada letra según las reglas
    .join(''); // Unimos el array en un string de nuevo
}
...
function copiarTexto() {
    // Utilizamos la API Clipboard para copiar el valor del textarea
